...
import type { POI } from "@/actions/getPOIs";
...
export function ServiceStationCard({
	...
	return (
		<Card
			className="overflow-hidden transition-all hover:shadow-lg p-2 pointer-events-auto cursor-pointer"
			onClick={onClick}
		>
